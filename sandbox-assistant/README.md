...
The agent runs on Anthropic's Managed Agents — a sandbox with a shell, a
filesystem and the web, on your Anthropic account.
...
Set `ALLOWED_SENDERS` before you register the webhook: this address reaches a
shell.
